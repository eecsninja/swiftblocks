Swift blocks - by Johan Öfverstedt
-----------------------------------------------
It's written in C++ using MSVC and the SDL-library.
Since I had never before made a game with C++ I wanted
to start out small, and so I decided to make a Tetris-clone.
I added nice graphics(for a programmer ;)) and a fun two-player mode.
Hope you will enjoy playing it, as much as I enjoyed making it!

SDL, SDL_Image and BFont are licensed under the LGPL.
All game specific code is released under the "Open Software License version 1.1".
...
Contact:
-----------------------------------------------
Johan Öfverstedt - johan_over@hotmail.com

License:
-----------------------------------------------

(C) Copyright Johan Öfverstedt
